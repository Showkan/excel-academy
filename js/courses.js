...
window.Courses = {
      ...
      <div class="container" style="padding: 32px 0;">
        ...
        <div style="display: grid; grid-template-columns: 1fr 320px; gap: 32px;" class="course-detail-layout">
          ...
          <div>
            ...
            <!-- Foundation Final Exam (faqat foundation kursida) -->
            ${courseId === 'foundation' && isLoggedIn ? `
              <div class="card" style="background: linear-gradient(135deg, rgba(247,181,0,0.1) 0%, rgba(247,181,0,0.05) 100%); border: 2px dashed var(--color-bonus);">
                <div class="card-body" style="text-align: center; padding: 32px;">
                  <div style="font-size: 48px; margin-bottom: 12px;">🏆</div>
                  <h3 style="margin-bottom: 8px;">Foundation Yakuniy Imtihon</h3>
                  <p style="color: var(--text-secondary); margin-bottom: 16px;">
                    Barcha darslarni tugatdingizmi? Imtihon topshirib, PRO kursni oching!
                  </p>
                  <p style="font-size: 13px; color: var(--text-muted); margin-bottom: 16px;">
                    📋 20 ta savol • ⏱️ 15 daqiqa • 🎯 80%+ o'tish
                  </p>
                  <button class="btn btn-yellow btn-lg" onclick="Router.navigate('exam/foundation')">
                    <i class="fas fa-trophy"></i> Imtihon boshlash
                  </button>
                </div>
              </div>
            ` : ''}
                ...
                ${!isLoggedIn ? `
                  <div style="margin-top: 20px; padding: 16px; background: var(--excel-green-pale); border-radius: var(--radius-md); text-align: center;">
                    <p style="font-size: 13px; color: var(--text-secondary); margin-bottom: 12px;">
                      ...
                      Faqat 2 ta dars ko'rish mumkin.
                    </p>
  ...
  _renderLessonItem(lesson, idx, course, completed, unlocked, isLoggedIn) {
    ...
    return `
      <div class="lesson-item ${statusClass}" onclick="${clickAction}">
        ...
        <div class="lesson-item-status">${statusIcon}</div>
      </div>
    `;
  },
  ...
  _getFallbackCourse(courseId) {
    if (courseId === 'foundation') {
      return {
        id: 'foundation', color: 'foundation', icon: 'fa-table',
        title: 'Excel Foundation', description: 'Excel asoslari',
        level: 'foundation', lessons_count: 8, duration: '8 kun',
        students: 0, rating: '4.8',
        modules: [{
          id: 'mod-1', title: 'Asoslar',
          lessons: [
    ...
    return {
      id: 'pro', color: 'pro', icon: 'fa-rocket',
      title: 'Excel PRO Automation', description: 'Excel professional',
      level: 'pro', lessons_count: 12, duration: '12 kun',
      students: 0, rating: '4.9',
      modules: [{
        id: 'mod-1', title: 'Advanced',
        lessons: [
...
console.log('%c📚 Courses yuklandi', 'color: #217346; font-weight: bold;');
